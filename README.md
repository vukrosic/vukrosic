...
**[nano-dates](https://github.com/vukrosic/nano-dates)** — a 1M-parameter byte-level transformer that parses natural date phrases into ISO-8601, trained **100% on data generated by code** (no scraping, no labelling). 85.4% held-out, with an honest map of where a nano model's reasoning breaks. → [model](https://huggingface.co/vukrosic/nano-dates) · [technical report (PDF)](https://github.com/vukrosic/nano-dates/blob/main/nano-dates-report.pdf)
